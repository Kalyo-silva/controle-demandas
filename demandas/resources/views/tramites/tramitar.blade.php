            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center pb-2 border-b border-gray-300">
                        <img src="{{asset('img'.DIRECTORY_SEPARATOR.'send.svg')}}" class='size-8 mr-2'>
                        <h1 class="text-xl font-bold">Tramitar</h1>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <form class="flex flex-col flex-1" enctype="multipart/form-data" action="{{route('tramites.store')}}" method="POST">
                        @csrf
                            ...
                            <div class="flex flex-col flex-1 ml-4 mt-4 mb-2">
                                ...
                                <div class="flex flex-col mb-1 w-full">
                                    <label for="user_id_atual" class="font-bold">Tramitar Para</label>
                                ...
                                <textarea name="complemento" 
                                        id="complemento" 
                                        class="rounded flex-1 h-full w-full border-gray-300 mb-2"></textarea>
